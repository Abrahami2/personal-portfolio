...
function f(e2, t2, n2, r2) {
  for (var o2 = [], a2 = 4; a2 < arguments.length; a2++) o2[a2 - 4] = arguments[a2];
  ...
  return u(this, void 0, void 0, function() {
    ...
    return c(this, function(S) {
      switch (S.label) {
        case 0:
          if (a2 = t2, o2) {
            for (u2 = 0, l2 = 1; l2 < t2.length; l2++) if (f2 = s([t2[l2 - 1], t2[l2]], 2), d2 = f2[0], (y2 = f2[1]).length > d2.length || "" === y2) {
              u2 = l2;
              break;
            }
  ...
  [h2, y2].forEach(function(e2, t2) {
    switch (typeof e2) {
      ...
      case "object":
        ...
        if ("number" != typeof o3) break;
        if ("keyStrokeDelayInMs" === r2) _[t2] = o3;
    }
  });
